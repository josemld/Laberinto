 ...
 */
public class RobotManoIzquierda extends RobotAbstract
{
	public static final Color CESTELA = Color.YELLOW;
	public static final Color CROBOT = Color.BLUE;
	 ...
	 */
	public RobotManoIzquierda ( String nombre, final Laberinto l )
	{
		super(nombre,l);
